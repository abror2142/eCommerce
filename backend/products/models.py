...
class Category(models.Model):
    name = models.CharField(max_length=150)
    has_size = models.BooleanField(default=False, null=True, blank=True) # used for type rendering
    has_memory = models.BooleanField(default=False, null=True, blank=True) # used for type rendering
    has_color = models.BooleanField(default=False, null=True, blank=True) # used for type rendering
